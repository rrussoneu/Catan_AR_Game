 ...
 * @return on success
 */
int ObjDrawer::draw_brick(cv::Mat &frame, std::vector<cv::Point2f> img_pts) {
 ...
 * @return on success
 */
int ObjDrawer::draw_sheep(cv::Mat &frame, std::vector<cv::Point2f> img_points) {
 ...
 * @return on success
 */
int ObjDrawer::draw_ore(cv::Mat &frame, std::vector<cv::Point2f> img_points) {
 ...
 * @return on success
 */
int ObjDrawer::draw_wheat(cv::Mat &frame, std::vector<cv::Point2f> img_points) {
...
int ObjDrawer::draw_wood(cv::Mat &frame, std::vector<cv::Point2f> img_points) {
    // bottom connecting
...
int ObjDrawer::draw_knight(cv::Mat &frame, std::vector<cv::Point2f> img_points) {
    for (int i = 1; i < 5; i++) {
